...
mod tests {
    ...
    fn test_native_br_if_block_first_shape() {
        ...
        let mut ops = vec![
            ...
            make_op(
                IrOpKind::BrIf { stack_drop: 0, arity: 0 },
                1,
            ),
    ...
    fn test_native_br_if_value_taken_preserves_branch_value() {
        ...
        let mut ops = vec![
            ...
            make_op(
                IrOpKind::BrIf { stack_drop: 0, arity: 1 },
                2,
            ),
    ...
    fn test_native_return_many_preserves_result_order() {
        ...
        let ops = vec![
            ...
            make_op(
                IrOpKind::Return { arity: 2, frame_size },
                2,
            ),
        ];
    ...
    fn test_native_internal_call_returns_single_i32() {
            ...
            vec![
                make_op(
                    IrOpKind::CallInternal {
                        callee: callee_ptr,
                        delta: crate::vm::wasm::SlotRef::operand_relative(0),
                    },
                    0,
                ),
                make_op(
        ...
        assert_eq!(
            ...
            caller_code.entry_at(1).expect("caller return entry") as usize as u64
        );
        assert_eq!(caller_code.helper_metadata()[0].next_resume_slots & 0xffff, 3);
    ...
    fn test_native_internal_call_runs_init_locals_before_frame_access() {
        ...
        compile_into_spec(
            ...
            vec![
                ...
                make_op(
                    IrOpKind::ReturnOne { frame_size: 7 },
                    1,
                ),
            ],
            1,
    ...
    fn test_native_internal_call_with_mixed_six_args_preserves_param0_after_init_locals() {
        ...
        compile_into_spec(
            ...
            vec![
                ...
                make_op(IrOpKind::LocalGetFrame { idx: 6 }, 0),
                make_op(
                    IrOpKind::ReturnOne { frame_size: 8 },
                    1,
                ),
            ],
            6,
    ...
    fn test_native_call_internal_spill_materializes_hot_local_alias() {
        ...
        compile_into_spec(
            ...
            vec![
                make_op(IrOpKind::LocalGetFrame { idx: 0 }, 0),
                make_op(
                    IrOpKind::ReturnOne { frame_size: 3 },
                    1,
                ),
            ],
            3,
