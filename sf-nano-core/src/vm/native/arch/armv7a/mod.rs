...
/// Truncate f64 to signed i64 (returns low 32 bits; high 32 bits discarded on ARM32).
pub(crate) extern "C" fn armv7a_f64_trunc_i64s(val: f64) -> u32 {
    (val as i64) as u32
}

/// Truncate f64 to unsigned i64 (returns low 32 bits).
pub(crate) extern "C" fn armv7a_f64_trunc_i64u(val: f64) -> u32 {
    (val as u64) as u32
}

/// Truncate f32 to signed i64 (returns low 32 bits).
pub(crate) extern "C" fn armv7a_f32_trunc_i64s(val: f32) -> u32 {
    (val as i64) as u32
}

/// Truncate f32 to unsigned i64 (returns low 32 bits).
pub(crate) extern "C" fn armv7a_f32_trunc_i64u(val: f32) -> u32 {
    (val as u64) as u32
}
