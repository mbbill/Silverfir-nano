...
//!
//! This owns one mmap-backed writable/executable region. The old backend used
//! a module-wide arena; the current bring-up also uses it as a per-function
//! executable allocation owned by `NativeCode`.
...
/// One mmap-backed executable buffer.
