...
impl<'a> CompileContext<'a> {
    ...
    #[inline]
    pub fn resolve_block_result_types(&self, block_type: &BlockType) -> alloc::vec::Vec<ValueType> {
        match block_type {
            BlockType::Empty => alloc::vec::Vec::new(),
    ...
    #[inline]
    pub fn resolve_block_result_types_from_imm(
        &self,
        imm: &Immediate,
    ) -> alloc::vec::Vec<ValueType> {
        match imm {
