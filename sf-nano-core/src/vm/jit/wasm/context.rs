...
pub(crate) struct CompileContext<'a> {
    ...
    pub(in crate::vm::jit::wasm) local_types: &'a [ValueType],
    /// Function result types in signature order.
    pub(in crate::vm::jit::wasm) result_types: &'a [ValueType],
}
...
impl<'a> CompileContext<'a> {
    ...
    #[inline]
    pub(in crate::vm::jit::wasm) fn resolve_block_type_from_imm(
        &self,
        imm: &Immediate,
    ) -> (u16, u16) {
        match imm {
    ...
    #[inline]
    pub(in crate::vm::jit::wasm) fn resolve_block_result_types_from_imm(
        &self,
        imm: &Immediate,
    ...
    #[inline]
    pub(in crate::vm::jit::wasm) fn resolve_type_index(&self, type_idx: u32) -> (u16, u16) {
        self.types
    ...
    #[inline]
    pub(in crate::vm::jit::wasm) fn resolve_func_type(&self, func_idx: u32) -> (u16, u16) {
    ...
    #[inline]
    pub(in crate::vm::jit::wasm) fn resolve_tag_type(&self, tag_idx: u32) -> (u16, u16) {
    ...
    #[inline]
    pub(in crate::vm::jit::wasm) fn resolve_try_table_block_type(
        &self,
        imm: &Immediate,
    ) -> (u16, u16) {
        match imm {
    ...
    #[inline]
    pub(in crate::vm::jit::wasm) fn resolve_try_table_result_types(
        &self,
        imm: &Immediate,
    ) -> collections::Vec<ValueType> {
        match imm {
