...
use crate::{
    error::WasmError,
    vm::{
        jit::arch::common::types::DebugRegion,
        ...
        jit::middle::cell::CellId,
        jit::middle::frame::FrameSpan,
        jit::middle::ssa_ir::ir::{
...
fn render_ssa_call_args(args: &crate::vm::jit::middle::ssa_ir::ir::SsaCallArgs) -> String {
    let suffix = args
        .live_suffix
        .iter()
        .map(|arg| {
...
fn render_ssa_call_operand_loc(
    ...
    match loc {
        ...
        crate::vm::jit::middle::ssa_ir::ir::SsaCallOperandLoc::Live { value, slot, .. } => {
            format!("v{}@fp[{}]", value.0, slot.0)
        }
    }
}

fn render_ssa_scalar_result_loc(
    loc: &crate::vm::jit::middle::ssa_ir::ir::SsaScalarResultLoc,
) -> String {
    match loc {
        crate::vm::jit::middle::ssa_ir::ir::SsaScalarResultLoc::Stack { slot, .. } => {
            format!("fp[{}]", slot.0)
        }
        crate::vm::jit::middle::ssa_ir::ir::SsaScalarResultLoc::Live { value, slot, .. } => {
            format!("v{}@fp[{}]", value.0, slot.0)
        }
    }
}
...
fn render_machine_return_value(
    value: &crate::vm::jit::machine::machine_ir::MachineReturnValue,
) -> String {
    use crate::vm::jit::machine::machine_ir::MachineReturnValue;
    match value {
...
fn render_machine_result_src(src: crate::vm::jit::machine::machine_ir::MachineResultSrc) -> String {
    use crate::vm::jit::machine::machine_ir::MachineResultSrc;
    match src {
