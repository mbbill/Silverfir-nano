...
use crate::{
    ...
    vm::{
        ...
        jit::machine::machine_ir::{
            fp_reg_index, MachineBlockId, MachineBlockParam, MachineCallArgs, MachineCallResults,
            MachineCallTarget, MachineEdge, MachineFloatWidth, MachineFrameRegion, MachineFuncId,
        ...
        match target {
            MachineCallTarget::Direct(callee) => {
                ...
                self.core.direct_call_patches.push(
                    crate::vm::jit::arch::common::types::DirectCallPatch::address_literal(
                        callee_patch,
                        *callee,
                    ),
                );
