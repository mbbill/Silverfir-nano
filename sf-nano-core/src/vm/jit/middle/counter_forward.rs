...
fn window_admissible(
    program: &SsaProgram,
    block: &crate::vm::jit::middle::ssa_ir::ir::SsaBlock,
    block_index: usize,
    facts: &ValueFacts,
    store_index: usize,
    load_index: usize,
...
fn call_op_uses_value(
    call: &crate::vm::jit::middle::ssa_ir::ir::SsaCallOp,
    value: SsaValue,
) -> bool {
    use crate::vm::jit::middle::ssa_ir::ir::{SsaCallOp, SsaCallOperandLoc};
    let args_use = |args: &crate::vm::jit::middle::ssa_ir::ir::SsaCallArgs| {
...
fn nonbranch_terminator_uses_value(terminator: &SsaTerminator, value: SsaValue) -> bool {
    use crate::vm::jit::middle::ssa_ir::ir::{SsaCallOperandLoc, SsaScalarResultLoc};
    let loc_uses = |loc: &SsaCallOperandLoc| matches!(loc, SsaCallOperandLoc::Live { value: v, .. } if *v == value);
    let args_use = |args: &crate::vm::jit::middle::ssa_ir::ir::SsaCallArgs| {
        args.live_suffix.iter().any(|arg| arg.value == value)
    };
...
fn terminator_uses_value(terminator: &SsaTerminator, value: SsaValue) -> bool {
    let edge_uses = |edge: &crate::vm::jit::middle::ssa_ir::ir::SsaEdge| {
