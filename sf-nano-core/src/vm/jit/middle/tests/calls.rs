...
use crate::vm::jit::middle::ssa_ir::ir::SsaOp;
...
fn hot_loop_with_call(direct: bool) -> crate::vm::jit::wasm::semantic_ir::SemanticProgram {
    use crate::vm::jit::wasm::primitive_op::PrimitiveOpKind;
    let call = if direct {
...
fn bounded_counter_reload_is_forwarded() {
    use crate::vm::jit::wasm::primitive_op::PrimitiveOpKind as P;
    ...
    let count_memloc_loads = |ssa: &crate::vm::jit::middle::ssa_ir::ir::SsaProgram, off: u32| {
        let mut count = 0;
