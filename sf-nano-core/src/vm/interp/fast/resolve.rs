...
fn lift_kind(kind: &LirOpKind) -> IrOpKind {
    match kind {
        ...
        LirOpKind::Marker(crate::vm::lir::ir::LirMarkerKind::Block { .. }) => IrOpKind::Block,
        LirOpKind::Marker(crate::vm::lir::ir::LirMarkerKind::Loop { .. }) => IrOpKind::Loop,
        LirOpKind::Marker(crate::vm::lir::ir::LirMarkerKind::If { .. }) => IrOpKind::If,
        LirOpKind::Marker(crate::vm::lir::ir::LirMarkerKind::Else) => IrOpKind::Else,
        LirOpKind::Marker(crate::vm::lir::ir::LirMarkerKind::End) => IrOpKind::End,
        LirOpKind::Branch {
