//! Raw value utilities used by the interpreter family.
//!
//! This stays above any particular fast/native backend. It is a plain value
//! representation helper for interpreter-oriented runtime storage.
