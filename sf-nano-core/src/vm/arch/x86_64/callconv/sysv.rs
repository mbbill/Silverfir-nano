...
pub(in crate::vm::arch::x86_64) const C_ARG0: X86Reg = X86Reg::RDI;
pub(in crate::vm::arch::x86_64) const C_ARG1: X86Reg = X86Reg::RSI;
pub(in crate::vm::arch::x86_64) const C_ARG2: X86Reg = X86Reg::RDX;
#[allow(dead_code)]
pub(in crate::vm::arch::x86_64) const C_ARG3: X86Reg = X86Reg::RCX;
...
#[inline]
pub(in crate::vm::arch::x86_64) fn emit_prologue_extra(_backend: &mut X86_64Backend) {}

#[inline]
pub(in crate::vm::arch::x86_64) fn emit_epilogue_extra(_backend: &mut X86_64Backend) {}
