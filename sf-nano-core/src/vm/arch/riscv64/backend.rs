...
use crate::{
    ...
    vm::{
        arch::{
            ...
            shared_64::{is_fallthrough_edge, EmittedFunction64, ModuleLinkBackend64},
        },
        machine::machine_ir::{
...
use crate::vm::arch::common::{
    helpers::{convert_result_float_width, trap_code},
...
impl<'a> Riscv64Backend<'a> {
    ...
    fn lower_trap_dispatch(&mut self, kind: MachineTrapKind) {
        ...
        let scratch = self.gp_scratch.scoped_alloc().detach();
        self.materialize_u64(*scratch, raise_trap as u64);
        self.core
            .text
            .emit_u32(enc::jalr(abi::link_reg(), *scratch, 0));
        let body_local_error_label = self.core.body_local_error_label;
