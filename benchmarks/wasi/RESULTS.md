...
| Benchmark             | Silverfir (JIT) | Cranelift |       V8 |  SF/CL |  SF/V8 |
|-----------------------|----------------:|----------:|---------:|-------:|-------:|
| STREAM Copy (MB/s)    |      **47,227** |    44,124 |   39,714 | 107.0% | 118.9% |
| STREAM Scale (MB/s)   |      **49,688** |    49,692 |   18,332 | 100.0% | 271.0% |
| STREAM Add (MB/s)     |      **64,375** |    48,398 |   29,989 | 133.0% | 214.7% |
| STREAM Triad (MB/s)   |      **48,426** |    47,864 |   30,869 | 101.2% | 156.9% |

## Summary

**SF vs Cranelift** (optimizing JIT): SF wins 9, CL wins 4, tied 1
- SF wins: CoreMark (217%), Lua fib (518%), Lua sunfish (160%), Lua json (153%), STREAM Add (133%), STREAM Copy (107%), LZ4 compress (104%), mandelbrot (103%), STREAM Triad (101%)
- Ties: STREAM Scale (100.0%)
- Closest losses: SHA-256 (96%), LZ4 decompress (93%)

**SF vs V8** (TurboFan JIT): SF wins 9, V8 wins 5
- SF wins: STREAM Scale (271%), mandelbrot (244%), STREAM Add (215%), STREAM Triad (157%), Lua fib (134%), STREAM Copy (119%), SHA-256 (118%), LZ4 decompress (110%), LZ4 compress (108%)
- Closest losses: CoreMark (84%), bzip2 (80%)
