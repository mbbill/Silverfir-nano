...
|-----------------------|----------------:|----------:|---------:|-------:|-------:|
| CoreMark (score)      |      **20,963** |    14,669 |   37,869 | 142.9% |  55.4% |
...
| mandelbrot (ms)       |       **1,265** |       855 |    2,035 |  67.6% | 160.9% |
| c-ray (ms)            |       **5,624** |     2,055 |    1,947 |  36.6% |  34.6% |
...
| lua/sunfish (score)   |       **3,568** |     2,896 |   11,101 | 123.2% |  32.1% |
...
- SF beats Cranelift on CoreMark (143%), Lua fib (316%), Lua sunfish (123%), Lua json (116%)
- SF beats V8 on mandelbrot (161%), STREAM Scale (147%), STREAM Add (104%)
