...
- 2025-10-11 (70085428) rationale: this generation lowers SSA straight to the XIR
  ...
  across the trampoline ABI, documented as the Phase-3 MVP with live-range reuse
  and tighter packing expected in later phases (diff).
...
- 2025-10-18 (9ff77d1b) replaced by [[vir-two-stage-middle]]: the old allocator
  ...
  virtual-register IR serves both the interpreter and a future JIT (diff).
