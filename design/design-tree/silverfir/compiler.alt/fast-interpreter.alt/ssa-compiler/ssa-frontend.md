...
- 2025-10-19 (4ea03b39) rationale: an SSA-reconstruction pipeline is built
  ...
  [[ssa-frontend.fact/why-reconstruct-ssa]] (diff).
...
- 2025-10-22 (639b766b) rationale: SSA IR keeps a 1:1 mapping with
  ...
  when structurally similar — to preserve a faithful, debuggable
  correspondence with the source bytecode; instruction merging is not done at
  the SSA layer (diff).
