...
Recovered from the interp branch (docs/DESIGN.md at 35f6164, "Fix heading formatting") — the authoritative, most-current fast-interpreter design paper, "Beating a JIT Compiler with an Interpreter." Heading markers stripped per the fact-file rule; text is otherwise verbatim.
