...
- 2025-12-05 (741d70e1) statement: STO is parked in imm2 now and imm0/imm1 are
  freed for primary instruction data (code).
...
- 2025-12-05 (741d70e1) statement: imm2 is reserved for the Stack Top Offset
  ...
  sized to later hold three packed slot indices (dest, operand A, operand B),
  avoiding a second immediate-layout churn when slot encoding lands (sourced).
