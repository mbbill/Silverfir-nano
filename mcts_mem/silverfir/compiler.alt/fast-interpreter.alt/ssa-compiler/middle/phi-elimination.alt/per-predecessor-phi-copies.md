...
- 2025-10-19 (e7e31a28) rationale: this first-generation phi elimination inserts
  ...
  by the straight-line copy order (code).

- 2025-10-19 (e7e31a28) rationale: the simple sequential-copy form was chosen
  because VIR already carried explicit register allocation and the MVP only
  needed the common non-overlapping case (sourced).
...
- 2025-10-25 (b2109ad2) pitfall: emitting phi-elimination copies in naive
  ...
  than emitted as a plain list (code).
