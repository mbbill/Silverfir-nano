...
- 2025-10-12 (1bdc24fd) statement: the store-with-binop (ST_BIN) fusion is
  ...
  store carrying the memory index (code).
...
- 2025-10-18 (10c5e2c9) rationale: only narrow, hardware-backed patterns are
  ...
  arbitrary op pairs were removed (code).

- 2025-10-18 (10c5e2c9) rationale: the generic two-level Bin2L/Bin2R fusions for
