...
- 2025-11-05 (1c6d574d) replaced by [[cfg-edges]]: control flow is encoded in block terminators, so stored predecessor/successor edges were redundant state the builder had to keep consistent at every branch; deriving the CFG from terminators makes terminators the single source of truth (code).
